  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-50 via-blue-50 to-indigo-50 py-8 px-4">
      <div className="max-w-4xl mx-auto">
          ...
          <div className="bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 px-6 py-5 relative overflow-hidden">
            ...
            <div className="relative flex items-center justify-between">
              <div className="flex items-center space-x-4">
                ...
                <div>
                  <h2 className="text-white font-bold text-xl tracking-tight">AI Support Agent</h2>
                  <p className="text-white/90 text-sm font-medium">We're here to help you!</p>
                </div>
              </div>
              {isTyping && (
                <div className="flex items-center space-x-2 bg-white/20 backdrop-blur-sm px-4 py-2 rounded-full">
                  <span className="text-white text-sm font-medium">Agent is typing</span>
        ...
        {/* Messages Area */}
        <div ref={messagesContainerRef} className="h-[600px] overflow-y-auto px-6 py-6 bg-gradient-to-b from-gray-50 to-white custom-scrollbar">
          {messages.length === 0 ? (
            <div className="flex flex-col items-center justify-center h-full text-center animate-fade-in">
              ...
              <p className="text-gray-600 mb-8 text-lg max-w-md">
                Ask me anything about our store, shipping, returns, or support. I'm here 24/7 to assist you!
              </p>
        ...
        <div className="px-6 py-5 bg-white border-t border-gray-100">
          ...
          <p className="text-xs text-gray-400 mt-3 text-center">
            Press <kbd className="px-2 py-1 bg-gray-100 rounded text-gray-600 font-mono">Enter</kbd> to send, <kbd className="px-2 py-1 bg-gray-100 rounded text-gray-600 font-mono">Shift+Enter</kbd> for new line
          </p>
        </div>
        </div>
      </div>
